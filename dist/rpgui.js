RPGUI = (function() {
    ...
    function touchStart(e) {
        ...
        var rect = _curr_dragged.getBoundingClientRect();
        _curr_dragged_point = {
            x: rect.left - e.changedTouches[0].pageX,
            y: rect.top - e.changedTouches[0].pageY
        };
    ...
    function divMove(e) {
        if (_curr_dragged) {
            _curr_dragged.style.position = 'fixed';
    ...
    function touchMove(e) {
        if (e.changedTouches.length > 0) {
            _curr_dragged.style.position = 'fixed';
            _curr_dragged.style.left = (e.changedTouches[0].pageX + _curr_dragged_point.x) + 'px';
            _curr_dragged.style.top = (e.changedTouches[0].pageY + _curr_dragged_point.y) + 'px';
        }
    }
